    ...
    $.ajax({
        ...
        success: async function (response) {
            ...
            if (element == "Error") {
                ...
                generatedText += `<div style = 'margin-block-end: 8%'>
                Disclaimer: This recipe and its image was generated by an artificial
                intelligence program and has not been taste-tested or reviewed by a human chef.
                The ingredients and cooking instructions are provided for informational purposes
                only and may not result in a tasty or safe dish. Use caution when preparing and 
                consuming this recipe, and make any necessary adjustments based on your own cooking 
                experience and preferences.  </div>`
